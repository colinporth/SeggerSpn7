...
#define MAX_APPLICATION_SPEED        5994 // rpm, mechanical
#define MIN_APPLICATION_SPEED           0 // rpm, mechanical, absolute value
#define MEAS_ERRORS_BEFORE_FAULTS       3 // Number of speed measurement errors before main sensor goes in fault

// Encoder *********************
#define ENC_MEAS_ERRORS_BEFORE_FAULTS   3 // Number of failed derived class specific speed measurements before main sensor goes in fault
#define ENC_ICx_FILTER                 50 // Duration of input capture filter in CPU clock cycles in case of quadrature encoder main or auxiliary sensors in use
#define ENC_INVERT_SPEED               DISABLE  // To be enabled for encoder (main or aux) if measured speed is opposite to real one
#define ENC_AVERAGING_FIFO_DEPTH       16 // depth of the FIFO used to average mechanical speed in 0.1Hz resolution

// Hall sensors ***********
#define HALL_MEAS_ERRORS_BEFORE_FAULTS  3 // Number of failed derived class specific speed measurements before main sensor goes in fault
#define HALL_ICx_FILTER                94 // Duration of input capture filter in CPU clock cycles in case of Hall sensors main or auxiliary sensors in use
...
#define BEMF_CONSISTENCY_TOL             64 // Parameter for B-emf amplitude-speed consistency
#define BEMF_CONSISTENCY_GAIN            64 // Parameter for B-emf amplitude-speed consistency

// State Observer + CORDIC **
#define CORD_VARIANCE_THRESHOLD          4  // Maxiumum accepted variance on speed estimates (percentage)
#define CORD_F1                          8192
#define CORD_F2                          16384

// State observer constants
#define CORD_GAIN1                       -10756
#define CORD_GAIN2                       11988

#define CORD_MEAS_ERRORS_BEFORE_FAULTS   3  // Number of consecutive errors on variance test before a speed feedback error is reported
#define CORD_FIFO_DEPTH_DPP              64 // Depth of the FIFO used to average mechanical speed in dpp format
#define CORD_FIFO_DEPTH_01HZ             64 // Depth of the FIFO used to average mechanical speed in dpp format
#define CORD_MAX_ACCEL_DPPP              17 // Maximum instantaneous electrical acceleration (dpp per control period)
#define CORD_BEMF_CONSISTENCY_TOL        64 //  Parameter for B-emf amplitude-speed consistency
#define CORD_BEMF_CONSISTENCY_GAIN       64 //  Parameter for B-emf amplitude-speed consistency
...
#define PID_TORQUE_KI_DEFAULT         2142
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2147
#define PID_FLUX_KI_DEFAULT           2142
...
#define PID_SPEED_KP_DEFAULT          2351
#define PID_SPEED_KI_DEFAULT          214
...
#define DEFAULT_TARGET_SPEED_RPM       1188
...
#define OV_VOLTAGE_THRESHOLD_V          36 // Over-voltage threshold
...
#define HW_OV_CURRENT_PROT_BYPASS       DISABLE // In case ON_OVER_VOLTAGE is set to TURN_ON_LOW_SIDES this feature may be used to
                                                          //bypass HW over-current protection (if supported by  power stage)
// *****************************   START-UP PARAMETERS   *********************
//  Encoder alignment
...
#define PHASE1_FINAL_CURRENT           20053
//  Phase 2
#define PHASE2_DURATION                2640 // milliseconds
#define PHASE2_FINAL_SPEED_RPM         1320 //  rpm
#define PHASE2_FINAL_CURRENT           20053
//  Phase 3
#define PHASE3_DURATION                0 // milliseconds
#define PHASE3_FINAL_SPEED_RPM         1320 //  rpm
#define PHASE3_FINAL_CURRENT           20053
//  Phase 4
#define PHASE4_DURATION                0 // milliseconds
#define PHASE4_FINAL_SPEED_RPM         1320 //  rpm
#define PHASE4_FINAL_CURRENT           20053
//  Phase 5
#define PHASE5_DURATION                0 //  milliseconds
#define PHASE5_FINAL_SPEED_RPM         1320 //  rpm
#define PHASE5_FINAL_CURRENT           20053

#define ENABLE_SL_ALGO_FROM_PHASE      2

//  Observer start-up output conditions
#define OBS_MINIMUM_SPEED_RPM          1188
#define NB_CONSECUTIVE_TESTS           2 //  corresponding to former NB_CONSECUTIVE_TESTS/ (TF_REGULATION_RATE/ MEDIUM_FREQUENCY_TASK_RATE)
#define SPEED_BAND_UPPER_LIMIT         17 // It expresses how much estimated speed can exceed forced stator electrical without being considered wrong.
...
#define OPEN_LOOP_K                   44        // Slope of V/F curve expressed in int16_t Voltage for each 0.1Hz of mecchanical frequency increment.
#define OPEN_LOOP_OFF                 4400      // Offset of V/F curve expressed in int16_t Voltage applied when frequency is zero.
...
#define CONSTANT1_Q                    23449
#define CONSTANT1_D                    23449
